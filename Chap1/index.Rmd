...
This chapter is currently being reviewed for publication in *Regional Studies in Marine Science*. Scripts and datasets are stored on CHONe II's Dataverse [online repository](https://doi.org/10.5683/SP2/5LJYXO).
...
setwd("/Volumes/Crystal/WEB/eldre-phd/Chap1")
rmarkdown::render(input = "index.Rmd", output_file = "C1_index.html")
```
